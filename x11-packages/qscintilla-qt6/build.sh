...
termux_step_configure () {
	...
	# such as '-Wl,-rpath,/data/user/0/com.termux/files/usr/lib'
	# and '-I/data/user/0/com.termux/files/usr/include/qt6/QtCore',
	# but fails to correctly set some other necessary build settings,
	# like 'aarch64-linux-android-clang++' and '-L/data/user/0/com.termux/files/usr/lib',
